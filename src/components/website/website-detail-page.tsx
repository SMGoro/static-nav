...
import { AIDetailGenerator } from './ai-detail-generator';
import { AIDetailGenerationResult } from '../../services/ai-detail-generation-service';
...
export function WebsiteDetailPage() {
  ...
  const handleDetailGenerated = (result: AIDetailGenerationResult) => {
    console.log('AI详细介绍生成完成:', result);
  };
              ...
              <div className="flex items-start gap-6">
                ...
                {website.featured && (
                      ...
                      <div className="flex items-center justify-end">
                        <ConnectivityIndicator url={website.url} />
                      </div>
                    </div>
                  </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Zap className="w-4 h-4" />
                    {showAIGenerator ? '隐藏AI生成器' : 'AI增强介绍'}
                  </Button>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="border-t pt-4">
                ...
                {/* 相关网站推荐 */}
                <RelatedRecommendations currentWebsite={website} maxResults={6} />
              </div>
