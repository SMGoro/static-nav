      ...
      {showAdvanced && (
        <div className="space-y-4 p-4 border rounded-lg bg-muted/50">
          ...
          <div className="space-y-2">
            <Label htmlFor="fullDescription">详细介绍 <span className="text-xs text-muted-foreground">(支持 Markdown)</span></Label>
            <MarkdownEditor
              value={formData.fullDescription}
              onChange={(value) => onDataUpdate({ fullDescription: value })}
              placeholder="输入网站的详细介绍，支持 Markdown 语法..."
              showToolbar={true}
              showPreview={true}
              minHeight="150px"
              maxHeight="400px"
