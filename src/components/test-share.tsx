...
export function TestShare() {
  ...
  const handleCreateTestShare = () => {
    try {
      ...
      const url = dataManager.createShareLink(localData, '测试分享数据', 7);
      setShareUrl(url);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-bold">分享功能测试</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Button onClick={handleCreateTestShare} className="w-full gap-2">
